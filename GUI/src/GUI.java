	...
	public void setHelpText()
	{
		...
		JTextArea helpText = new JTextArea(
				"		How To Play SafeCracker"
						...
						+ "\n"
						+ "However, it is important to choose wisely. Some safes are easier to crack than others."
						+ "\n"
						+ " There are two number associated with each safe, digits and directions."
						+ "\n"
						+ "Digits tells you have many values are in a combo, obviously a safe with 7 digits will be harder to crack than a safe with 4"
						+ "\n"
						+ "Digits includes the number of directions that are in the combination. There 4 directions that can be part of a "
						+ "\n"
						+ "combo: U,D,L and R."
						+ "\n"
						+ "Any Digit that is not a directions, is a number from 0-9"
						+ "\n"
						+ "To pick a safe as your next target, you can press the button with its name, or type the number (or direction) listed to the left of the name"
						+ "\n"
						+ "\n"
						+ "Cracking a Safe"
						+ "\n"
						...
						+ "\n"
						+ " All safes have numbers, but only some will have directions."
						+ "\n"
						+ "You can enter a digit using the keyboard or by clicking on the button found on the screen. Note that"
						+ "\n"
						+ "Directions can be dictated with the arrow keys when not using analysis mode."
						+ "\n"
						...
						+ "\n"
						+ "Say a combination is 123UD, and you guess 321RU. There will be 4 digits correct, but only 1 posistion correct."
						+ "\n"

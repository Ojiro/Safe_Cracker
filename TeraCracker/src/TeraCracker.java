 ...
 *  The Interface class deals with the gui and event driven code.
 *  
...
{
	Player player;
	CrackerJacker dexter;
	Safe gameBox;
		
	public static void main(String[] args)
	{
		
		//testing the interactions of the classes
		TeraCracker testCode=new TeraCracker();
	...
	public void testCode()
	{
		...
		player= new Player();
		dexter=new CrackerJacker(player);
		player.setJacker(dexter);
		Interface window= new Interface(dexter);
		
		window.LevelSelect();
	
	}
} // ends TeraCracker Class
